package com.devhammad.tasksynckro.Database;
...
public interface OnDataBaseAction {
    ...
    @Query("UPDATE Task SET taskTitle = :taskTitle, taskDescription = :taskDescription, date = :taskDate, firstAlarmTime = :taskTime WHERE taskId = :taskId")
